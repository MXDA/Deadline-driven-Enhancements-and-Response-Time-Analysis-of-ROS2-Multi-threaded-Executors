 ...
 */
  ...
  class MultiThreadTimedExecutor : public rclcpp::Executor 
  {
    public:
      RCLCPP_SMART_PTR_DEFINITIONS(MultiThreadTimedExecutor)
      RCLCPP_PUBLIC
      ...
      RCLCPP_PUBLIC
      virtual ~MultiThreadTimedExecutor();
    ...
    private:
      ...
      rclcpp::detail::MutexTwoPriorities wait_mutex_;
